...
//		line_graph1_js = js + '/exchart1/line_graph1.js'
//		chart_area_demo_js = js + '/exchart/chart-area-demo.js'
//		chart_min_js = js + '/exchart/Chart.min.js'
	}
	...
	let onCreate =()=>{
		...
		$.when(
			...
			$.getScript(event_js),
			$.getScript(faq_js)
//			$.getScript(line_graph1_js)
//			$.getScript(chart_min_js),
//			$.getScript(chart_area_demo_js)
		)
		.done(()=>{
			setContentView()
			page_move()			
