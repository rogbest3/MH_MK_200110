...
<%-- 	<script src="<%=application.getContextPath()%>/resources/js/exchart1/line_graph1.js"></script> --%>
<%-- 	<script src="<%=application.getContextPath()%>/resources/vender/chart.js/Chart.min.js"></script>	 --%>
<%-- 	<script src="<%=application.getContextPath()%>/resources/js/demo/chart-area-demo.js"></script>	 --%>
